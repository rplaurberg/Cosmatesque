...
We can interpret this as signifying two possible ways to move from each square to the move immediately to the right.  This can mean two differently colored paths, if we're talking paths, or perhaps two different flourishes if we're imagining chess pieces.  The number of ways of combining these colors/flourishes compounds as we proceed:
